...
<tr>
<tr>
  	<td bgcolor="#EEEEEE">จำนวนทั้งหมด</td>
  	<td><input name="total_qty" type="text" id="phone"  value="" /></td>
</tr>
<tr>
  	<td bgcolor="#EEEEEE">ผลราม</td>
  	<td><input name="total" type="text" id="phone" required value="<?php echo number_format($total,2) ?>" /></td>
</tr>
