...
?>
  ...
  <td>
    ...
    <input type="hidden" name="txtimstatus<?php echo $i;?>" value="สั่งซื้อ">
...
<input type="hidden" name="buystatus" value="รอการยืนยัน">
  <input type="hidden" name="hdnNo" value="<?php echo $i;?>">
  <input type="text" name="usb_ID" value="<?php echo $_SESSION["username"];?>">
</form>
